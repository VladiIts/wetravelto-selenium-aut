...
public class SignUpWithEmail_TooltipValid_SpecChar_Test {
	...
	public void WT_SU_01_00_00_00test() {
		...
		System.out.println("Actual 'Sign Up' links landing page URL is: " + actualUrl1 + "\nExpected 'Sign Up' links landing page URL is: " + expectedURL1 + "\n"  );
	}
	...
	public void Email_SpecChar_TooltipValidation_Test() throws Exception {
		// WT # S.U. 01.00-05
		...
		// when clicked on Email element in the page to inspect (Arrow on the left on FIrebug), entered value "%^&*()$#" into Email field, 
