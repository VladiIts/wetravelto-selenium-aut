...
public class SignUpWithEmail_TooltipValid_UpCaseNoAtSign_Test {
	...
	public void WT_SU_01_00_00_00test() {
		...
		System.out.println("Sign Up links landing page actual URL is: " +  ActualUrl1 + "\nSign Up links landing page expected URL is: " + expectedURL1 + "\n" );
	}
	...
	public void WT_SU_01_00_00_02_Test() {
		...
		driver.findElement(By.xpath(".//*[@id='user_email']")).sendKeys("ASDFGH");
	...
	public void Email_UpCaseNoAtSign_TooltipValidation_Test() throws Exception {
		// WT # S.U. 01.00-04.01
		...
		// Used FF/Firebug, clicked on DOM in Firebug, 
		// when clicked on Email element in the page to inspect (Arrow on the left on FIrebug), entered value "ASDFGH" into Email field, 
		//- in FIrebug, under DOM ( Window > input#use...-control), shown attribute "validationMessage" with value "Please enter an email address."
